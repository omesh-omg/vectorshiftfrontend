...
const generateHandleStyles = (handles) => {
...
const NodeTemplate = ({
  ...
  const sourceHandlesWithStyles = generateHandleStyles(sourceHandles);
  const targetHandlesWithStyles = generateHandleStyles(targetHandles);

  // Call updateNodeInternals whenever sourceHandles or targetHandles change
  useEffect(() => {
    updateNodeInternals(id);
  }, [sourceHandles, targetHandles, updateNodeInternals, id]);
